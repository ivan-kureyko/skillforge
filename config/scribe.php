...
return [
    ...
    'description' => 'REST API for managing personal learning: courses, skills, goals, and progress.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Use a Bearer token obtained from the /api/login endpoint.',
    ],
